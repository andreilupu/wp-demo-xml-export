...
if ( ! defined( 'ABSPATH' ) || class_exists( 'WPGitHubUpdater' ) || class_exists( 'WP_DemoXml_GitHub_Updater' ) )
	return;
 ...
 */
class WP_DemoXml_GitHub_Updater {
	...
	public function upgrader_post_install( $true, $hook_extra, $result ) {
		...
		$fail  = __( 'The plugin has been updated, but could not be reactivated. Please reactivate it manually.', 'demo_xml' );
		$success = __( 'Plugin reactivated successfully.', 'demo_xml' );
